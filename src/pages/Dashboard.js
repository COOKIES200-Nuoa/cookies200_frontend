...
var Dashboard = function () {
    ...
    useEffect(function () {
        var fetchDashboardUrl = function () { return __awaiter(void 0, void 0, void 0, function () {
            var idToken, response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        idToken = auth.getIdToken();
                        if (!idToken) return [3 /*break*/, 6];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                    ...
                    case 4:
                        error_1 = _a.sent();
                        console.error('Error fetching QuickSight embed URL:', error_1);
                        return [3 /*break*/, 5];
